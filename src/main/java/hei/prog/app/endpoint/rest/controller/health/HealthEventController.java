...
import static hei.prog.app.endpoint.rest.controller.health.PingController.KO;
import static hei.prog.app.endpoint.rest.controller.health.PingController.OK;
import static java.util.UUID.randomUUID;

import hei.prog.app.PojaGenerated;
import hei.prog.app.endpoint.event.EventProducer;
import hei.prog.app.endpoint.event.model.DurablyFallibleUuidCreated1;
import hei.prog.app.endpoint.event.model.DurablyFallibleUuidCreated2;
import hei.prog.app.endpoint.event.model.UuidCreated;
import hei.prog.app.repository.DummyUuidRepository;
import hei.prog.app.repository.model.DummyUuid;
