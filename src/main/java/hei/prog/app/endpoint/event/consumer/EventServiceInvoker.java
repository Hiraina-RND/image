package hei.prog.app.endpoint.event.consumer;

import hei.prog.app.PojaGenerated;
import hei.prog.app.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("hei.prog.app.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "hei.prog.app.service.event." + typeNameAsArray[typeNameAsArray.length - 1] + "Service";
  }
