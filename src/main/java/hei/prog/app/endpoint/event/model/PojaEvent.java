package hei.prog.app.endpoint.event.model;

import static hei.prog.app.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import hei.prog.app.PojaGenerated;
import hei.prog.app.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    if (getEventStack().equals(EVENT_STACK_1)) return "hei.prog.app.event1";
    return "hei.prog.app.event2";
  }
}
